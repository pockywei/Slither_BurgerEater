...
class ViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		let Clips1:Clipping=collection_arr.addentity2("img1",Des: "1 foo")
		let Clips2:Clipping=collection_arr.addentity2("img2",Des: "2 foo")
		var Clips3:Clipping=collection_arr.addentity2("img3",Des: "3 bar")
